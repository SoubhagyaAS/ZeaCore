/*
  ...
  1. New Tables
    - `invoices`
      ...
      - `subscription_id` (uuid, foreign key to customer_subscriptions, nullable)
      ...
      - `notes` (text, nullable)
      - `invoice_type` (text: subscription, one-time)
    ...
    - `invoice_items`
      ...
      - `feature_id` (uuid, foreign key to app_features, nullable)
      - `created_at` (timestamp)

    - `payment_methods`
      - `id` (uuid, primary key)
      - `customer_id` (uuid, foreign key to customers)
      - `method_type` (text: card, bank_transfer, paypal, etc.)
      - `is_default` (boolean)
      - `details` (jsonb)
    ...
    - `payment_transactions`
      ...
      - `gateway` (text: stripe, paypal, manual, etc.)
